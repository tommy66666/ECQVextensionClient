...
public class HttpMethod {
	 ...
	 *new get function
	 */
	public static String GETreq(Integer num, String cer, String T, String z, String encoding) throws Exception{
		...
		//cer
		url.append("&");
		url.append("cer").append("=");
		url.append(cer);
		//t
		url.append("&");
		url.append("postT").append("=");
		url.append(T);
		//z
		url.append("&");
		url.append("postZ").append("=");
		url.append(z);
	...
	//overload
	public static String GETreq(Integer num, String cer, String encoding) throws Exception{
		StringBuilder url = new StringBuilder(IPaddress.IP_send_SITE);
		url.append("?");
		url.append("num").append("=");
		url.append(num.toString());
